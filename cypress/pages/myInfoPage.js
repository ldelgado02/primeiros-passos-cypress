class MyInfoPage {
    ...
    fillEmployeeDetails(employeeId, otherId, driversLicenseNumber, driversLicenseDate) {
        cy.get(this.selectorsList().defautlField).eq(3).clear().type(employeeId)
        cy.get(this.selectorsList().defautlField).eq(4).clear().type(otherId)
        cy.get(this.selectorsList().defautlField).eq(5).clear().type(driversLicenseNumber)
        cy.get(this.selectorsList().defautlField).eq(6).clear().type(driversLicenseDate)
